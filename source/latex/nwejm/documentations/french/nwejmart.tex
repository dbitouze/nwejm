...
\begin{dbwarning}{Commande \protect\refCom{articlesetup} : pas en préambule !}{}
  ...
  le corps du document (de préférence juste après |\begin{document}|) sans quoi la
    configuration choisie, certes prise en compte dans l'article isolé, risque de ne pas
    l'être dans le volume complet !
\end{dbwarning}
