...
% ngerman % If the language of the article will be German
...
% 1st argument:  ⟨label⟩ (also called key) of the acronym,
% 2nd argument:  ⟨short form of the acronym⟩ (lowercase!),
% 3nd argument:  ⟨long form of the acronym⟩,
% and use them with \gls{⟨label⟩} (or, if needed, with \acrshort{⟨label⟩}).
% This will require an extra `makeglossaries' compilation. See `glossaries'
...
%
%
% Acknowledgments, if any, are entered thanks to \acknowledgments command,as
...
\begin{itemize}
\item It has been proved in \century{19} \aside{more than 100 years ago}
  that...
\item Moreover, this has been proved in \century{-3} \aside*{more than 2000
    years ago}.
\end{itemize}
%
