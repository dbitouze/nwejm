...
\texorpdfstring{\nwejm}{NWEJM}]{Documentation de la classe \LaTeX{} du \nwejm*{}
  destinée aux auteurs} \subtitle[short=Version 0.98a (01/01/2017)]{\small
  Version 0.98a en date du 1\ier{} janvier 2017}
%
\author[%
affiliation={%
...
\begin{preamblecode}[listing options={deletekeywords={[2]article,title},deletekeywords={[1]definition},morekeywords={[2]{title}},morekeywords={[3]{definition}}}]
\newtheorem{article}
\newtheorem[title/french=Fait,style=definition]{fact}
\end{preamblecode}
\begin{bodycode}[listing and text,listing options={deletekeywords={[2]article}}]
